...
<div style='margin-top: 9px;'><header>
        ...
        <p style="line-height:0px;margin-left:-290px;">ФИО </p><br><input type="text" name="FIO" pattern='^[A-Za-zА-Яа-яЁё\s]+$' class="some-input" required="required" style="margin: -27px 0 20px 0;"><br>
        ...
        <p style="line-height:0px;margin-left:-300px;">MAIL </p><br><input type="text" name="Email" pattern='^[A-Za-z0-9\s]+@[A-Za-z\s]+\.[A-Za-z\s]+$'class="some-input" required="required" style="margin: -27px 0 20px 0;"><br>
        </p>
